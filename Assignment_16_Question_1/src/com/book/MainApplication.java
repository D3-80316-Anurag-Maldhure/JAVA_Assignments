...
//Save books in file and load books from file. Use DataOutputStream and DataInputStream.
...
//					9. Reverse the list -- Collections.reverse(list);
				...
				case SAVE_BOOKS_IN_FILE:
					System.out.println("----------------------------------------");
					try(FileOutputStream fout = new FileOutputStream("BOOKLIST.text")) {
				...
				case LOAD_BOOKS_FROM_FILE:
					try(FileInputStream fin = new FileInputStream("BOOKLIST.text")) {
